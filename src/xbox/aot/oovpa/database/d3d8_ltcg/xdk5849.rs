...
// Regenerate with: python3 tools/import_xbsymdb_database.py --xdk 5849
...
// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADERDIRECT_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0013, 0x00),
    ov!(0x0014, 0xB9),
...
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADERDIRECT_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_SETLIGHT_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x44),
    ov!(0x0022, 0x83),
    ov!(0x0023, 0xE0),
...
static D3D8_LTCG_D3DDEVICE_SETLIGHT_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3DDEVICE_SETSCREENSPACEOFFSET_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xD9),
    ov!(0x0001, 0x44),
    ov!(0x0002, 0x24),
    ov!(0x0003, 0x04),
...
static D3D8_LTCG_D3DDEVICE_SETSCREENSPACEOFFSET_1024_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x000D,
    target: "D3D_g_pDevice",
}];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0002, 0x08),
    ov!(0x00CB, 0x77),
    ov!(0x00CC, 0x07),
    ov!(0x00CD, 0xB8),
...
static D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETPALETTE_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x8B),
    ov!(0x0013, 0x85),
    ov!(0x0014, 0xC0),
...
static D3D8_LTCG_D3DDEVICE_SETPALETTE_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x51),
    ov!(0x0001, 0x53),
    ov!(0x0077, 0xC7),
    ov!(0x0078, 0x40),
...
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADERPROGRAM_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0006, 0xA1),
    ov!(0x000B, 0x74),
    ov!(0x0019, 0xC7),
    ov!(0x001A, 0x80),
...
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADERPROGRAM_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERTARGETFAST_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x8B),
    ov!(0x0007, 0xA9),
    ov!(0x0008, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERTARGETFAST_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3D_BLOCKONTIME_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x00B4, 0xC7),
    ov!(0x00B5, 0x47),
...
static D3D8_LTCG_D3D_BLOCKONTIME_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_BEGINPUSHBUFFER_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0045, 0x00),
    ov!(0x0046, 0x81),
...
static D3D8_LTCG_D3DDEVICE_BEGINPUSHBUFFER_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_CREATEPIXELSHADER_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x0D),
    ov!(0x0022, 0x85),
    ov!(0x0023, 0xC0),
...
static D3D8_LTCG_D3DDEVICE_CREATEPIXELSHADER_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_END_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x003C, 0x10),
    ov!(0x003D, 0x89),
    ov!(0x003E, 0x56),
...
static D3D8_LTCG_D3DDEVICE_END_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_GETVIEWPORTOFFSETANDSCALE_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x88),
    ov!(0x0007, 0xE0),
    ov!(0x0008, 0x0E),
...
static D3D8_LTCG_D3DDEVICE_GETVIEWPORTOFFSETANDSCALE_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_LOADVERTEXSHADERPROGRAM_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0001, 0x44),
    ov!(0x0006, 0xB7),
    ov!(0x0007, 0x58),
    ov!(0x0008, 0x02),
...
static D3D8_LTCG_D3DDEVICE_LOADVERTEXSHADERPROGRAM_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x44),
    ov!(0x0013, 0x00),
    ov!(0x0014, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DRESOURCE_RELEASE_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0006, 0x06),
    ov!(0x0007, 0x8B),
    ov!(0x0008, 0xC8),
...
static D3D8_LTCG_D3DRESOURCE_RELEASE_1024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_GET2DSURFACEDESC_1024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0038, 0x79),
    ov!(0x0039, 0x09),
...
static D3D8_LTCG_GET2DSURFACEDESC_1024_XREFS: &[OovpaXref] = &[];
...
// Source: D3D8LTCG/5120.inl
static D3D8_LTCG_DIRECT3D_CREATEDEVICE_1036_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0009, 0xC0),
    ov!(0x0012, 0x00),
    ov!(0x0013, 0x00),
...
static D3D8_LTCG_DIRECT3D_CREATEDEVICE_1036_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_BEGINPUSH_4_1036_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0006, 0x6A),
    ov!(0x0007, 0x00),
    ov!(0x0016, 0x8B),
...
static D3D8_LTCG_D3DDEVICE_BEGINPUSH_4_1036_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0001,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_SETPALETTE_1036_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x8B),
    ov!(0x0016, 0x00),
    ov!(0x0017, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SETPALETTE_1036_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3DDEVICE_LIGHTENABLE_1036_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0024, 0xF6),
    ov!(0x0025, 0x44),
...
static D3D8_LTCG_D3DDEVICE_LIGHTENABLE_1036_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_BEGIN_1036_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0034, 0x81),
    ov!(0x0035, 0x4E),
...
static D3D8_LTCG_D3DDEVICE_BEGIN_1036_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4F_1036_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0026, 0xB9),
    ov!(0x0027, 0x18),
...
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4F_1036_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3D_KICKOFFANDWAITFORIDLE2_1036_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x000F, 0x8B),
    ov!(0x0010, 0x4C),
    ov!(0x0011, 0x24),
...
static D3D8_LTCG_D3D_KICKOFFANDWAITFORIDLE2_1036_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3D_MAKEREQUESTEDSPACE_8_1036_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x51),
    ov!(0x0001, 0x53),
    ov!(0x0058, 0x81),
    ov!(0x0059, 0xC5),
...
static D3D8_LTCG_D3D_MAKEREQUESTEDSPACE_8_1036_XREFS: &[OovpaXref] = &[];
...
// Source: D3D8LTCG/5028.inl
static D3D8_LTCG_D3D_COMMONSETRENDERTARGET_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0057, 0x8B),
    ov!(0x0058, 0x49),
...
static D3D8_LTCG_D3D_COMMONSETRENDERTARGET_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5120.inl
static D3D8_LTCG_D3DDEVICE_SETPALETTE_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x8B),
    ov!(0x0011, 0x00),
    ov!(0x0012, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SETPALETTE_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_DRAWINDEXEDVERTICESUP_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0003, 0x83),
    ov!(0x0004, 0xEC),
    ov!(0x0005, 0x14),
...
static D3D8_LTCG_D3DDEVICE_DRAWINDEXEDVERTICESUP_1048_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x000A,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_DRAWVERTICESUP_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0003, 0x83),
    ov!(0x0004, 0xEC),
    ov!(0x0005, 0x14),
...
static D3D8_LTCG_D3DDEVICE_DRAWVERTICESUP_1048_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x000A,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_END_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0007, 0x8B),
    ov!(0x0013, 0x50),
    ov!(0x001C, 0xC7),
    ov!(0x0022, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_END_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_SETSCISSORS_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0001, 0xEC),
    ov!(0x0016, 0x55),
    ov!(0x0017, 0x89),
    ov!(0x0018, 0x44),
...
static D3D8_LTCG_D3DDEVICE_SETSCISSORS_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_CDEVICE_KICKOFF_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x41),
    ov!(0x0002, 0x08),
    ov!(0x0003, 0xA8),
...
static D3D8_LTCG_CDEVICE_KICKOFF_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3DDEVICE_SETVIEWPORT_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x4C),
    ov!(0x0002, 0x24),
    ov!(0x0003, 0x04),
...
static D3D8_LTCG_D3DDEVICE_SETVIEWPORT_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3D_KICKOFFANDWAITFORIDLE2_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0013, 0x8B),
    ov!(0x0014, 0x4C),
    ov!(0x0015, 0x24),
...
static D3D8_LTCG_D3D_KICKOFFANDWAITFORIDLE2_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_RUNPUSHBUFFER_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x004B, 0xC7),
    ov!(0x004C, 0x44),
...
static D3D8_LTCG_D3DDEVICE_RUNPUSHBUFFER_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_BORDERCOLOR_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0020, 0x08),
    ov!(0x0021, 0x8B),
    ov!(0x0022, 0xD1),
...
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_BORDERCOLOR_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3D_SETFENCE_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0021, 0xC7),
    ov!(0x0022, 0x00),
...
static D3D8_LTCG_D3D_SETFENCE_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_BEGINVISIBILITYTEST_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x001D, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_BEGINVISIBILITYTEST_1048_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0003,
    target: "D3D_g_pDevice",
}];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x54),
    ov!(0x0014, 0xC7),
    ov!(0x0015, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA2F_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x0021, 0x8D),
...
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA2F_1048_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0003,
    target: "D3D_g_pDevice",
}];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA2S_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0021, 0x8D),
    ov!(0x0024, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA2S_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4S_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0034, 0x80),
    ov!(0x0035, 0x19),
    ov!(0x0036, 0x08),
...
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4S_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4UB_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0021, 0x8D),
    ov!(0x0024, 0x40),
    ov!(0x0025, 0x19),
...
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4UB_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SWAP_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0001, 0x8B),
    ov!(0x0027, 0x75),
    ov!(0x0028, 0x05),
    ov!(0x0029, 0xBB),
...
static D3D8_LTCG_D3DDEVICE_SWAP_1048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3D_BLOCKONTIME_1048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x00F0, 0xC7),
    ov!(0x00F1, 0x47),
...
static D3D8_LTCG_D3D_BLOCKONTIME_1048_XREFS: &[OovpaXref] = &[];
...
// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_CULLMODE_1053_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0023, 0xC7),
    ov!(0x0024, 0x00),
    ov!(0x0025, 0x08),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_CULLMODE_1053_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3D_COMMONSETRENDERTARGET_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x005A, 0x8B),
    ov!(0x005B, 0x49),
...
static D3D8_LTCG_D3D_COMMONSETRENDERTARGET_1060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x0031, 0x74),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1060_XREFS: &[OovpaXref] =
    &[OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    }];
...
// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_SETVIEWPORT_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x013C, 0x00),
    ov!(0x013D, 0x5D),
...
static D3D8_LTCG_D3DDEVICE_SETVIEWPORT_1060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_EDGEANTIALIAS_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0001, 0x8B),
    ov!(0x001E, 0x4C),
    ov!(0x0022, 0x00),
    ov!(0x0023, 0x20),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_EDGEANTIALIAS_1060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FILLMODE_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x001D, 0x8B),
    ov!(0x0023, 0x8B),
    ov!(0x0033, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FILLMODE_1060_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x001F,
        target: "D3DRS_TwoSidedLighting",
    },
...
// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FOGCOLOR_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0024, 0x54),
    ov!(0x0025, 0x24),
    ov!(0x0026, 0x0E),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FOGCOLOR_1060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FRONTFACE_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x002A, 0x83),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FRONTFACE_1060_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_LOGICOP_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0023, 0x75),
    ov!(0x0025, 0xC7),
    ov!(0x0026, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_LOGICOP_1060_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_NORMALIZENORMALS_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0023, 0xA4),
    ov!(0x0024, 0x03),
    ov!(0x0025, 0x04),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_NORMALIZENORMALS_1060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_SHADOWFUNC_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0007, 0x8B),
    ov!(0x0023, 0x6C),
    ov!(0x0024, 0x1E),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_SHADOWFUNC_1060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_STENCILENABLE_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x0075, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_STENCILENABLE_1060_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_STENCILFAIL_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x005E, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_STENCILFAIL_1060_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_ZENABLE_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0037, 0xC9),
    ov!(0x0038, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_ZENABLE_1060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3D_SETFENCE_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x8A),
    ov!(0x0025, 0xC7),
    ov!(0x0026, 0x00),
...
static D3D8_LTCG_D3D_SETFENCE_1060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_1060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0106, 0x77),
    ov!(0x0107, 0x07),
    ov!(0x0108, 0xB8),
...
static D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_1060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1061_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x0032, 0x74),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1061_XREFS: &[OovpaXref] =
    &[OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    }];
...
// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_1072_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0026, 0xA9),
    ov!(0x0027, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_1072_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_1084_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0025, 0xA9),
    ov!(0x0026, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_1084_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1084_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0001, 0x8B),
    ov!(0x0022, 0xC7),
    ov!(0x0023, 0x00),
    ov!(0x0024, 0xC4),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1084_XREFS: &[OovpaXref] = &[];
...
// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETPALETTE_4__LTCG_EAX1_2024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x55),
    ov!(0x0014, 0x00),
    ov!(0x0015, 0x00),
...
static D3D8_LTCG_D3DDEVICE_SETPALETTE_4__LTCG_EAX1_2024_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADERCONSTANT_4__LTCG_ECX1_EAX3_2024_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0004, 0xEC),
    ov!(0x004C, 0xF3),
    ov!(0x004D, 0x0F),
...
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADERCONSTANT_4__LTCG_ECX1_EAX3_2024_XREFS: &[OovpaXref] = &[];
...
// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_BORDERCOLOR_0__LTCG_EAX1_EBX2_2036_ENTRIES:
    &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0021, 0x8B),
    ov!(0x0022, 0xCE),
...
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_BORDERCOLOR_0__LTCG_EAX1_EBX2_2036_XREFS:
    &[OovpaXref] = &[];

// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_SETVERTEXSHADER_0__LTCG_EBX1_2036_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x51),
    ov!(0x0001, 0xF6),
    ov!(0x0002, 0xC3),
    ov!(0x0003, 0x01),
...
static D3D8_LTCG_D3DDEVICE_SETVERTEXSHADER_0__LTCG_EBX1_2036_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x000E,
    target: "D3DDevice__m_VertexShader_OFFSET",
}];
...
// Source: D3D8LTCG/5028.inl
static D3D8_LTCG_DIRECT3D_CREATEDEVICE_16__LTCG_EAX4_ECX6_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x000D, 0x85),
    ov!(0x000E, 0xC9),
    ov!(0x000F, 0x75),
...
static D3D8_LTCG_DIRECT3D_CREATEDEVICE_16__LTCG_EAX4_ECX6_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x85),
    ov!(0x0001, 0xC0),
    ov!(0x0003, 0x8B),
    ov!(0x0047, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADERDIRECT_0__LTCG_EAX1_EBX2_2048_ENTRIES:
    &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x56),
    ov!(0x0002, 0x8B),
...
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADERDIRECT_0__LTCG_EAX1_EBX2_2048_XREFS: &[OovpaXref] =
    &[];

// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_0__LTCG_ECX1_EAX2_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x68),
    ov!(0x0005, 0x50),
    ov!(0x0006, 0x51),
    ov!(0x0007, 0xE8),
...
static D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_0__LTCG_ECX1_EAX2_2048_XREFS: &[OovpaXref] =
    &[OovpaXref {
        offset: 0x0008,
...
// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_SETVERTEXSHADERCONSTANTNOTINLINE_0__LTCG_EBX1_EDX2_EAX3_2048_ENTRIES:
    &[OovpaEntry] = &[
    ov!(0x0000, 0xF6),
    ov!(0x0001, 0x05),
    ov!(0x0009, 0x56),
...
static D3D8_LTCG_D3DDEVICE_SETVERTEXSHADERCONSTANTNOTINLINE_0__LTCG_EBX1_EDX2_EAX3_2048_XREFS:
    &[OovpaXref] = &[];

// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_LIGHTENABLE_4__LTCG_EAX1_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0022, 0xF6),
    ov!(0x0023, 0x44),
...
static D3D8_LTCG_D3DDEVICE_LIGHTENABLE_4__LTCG_EAX1_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_0__LTCG_EAX1_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x51),
    ov!(0x0001, 0x85),
    ov!(0x0073, 0xC7),
    ov!(0x0074, 0x40),
...
static D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_0__LTCG_EAX1_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3D_BLOCKONTIME_4__LTCG_EAX1_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x00B8, 0xC7),
    ov!(0x00B9, 0x47),
    ov!(0x00BA, 0x10),
...
static D3D8_LTCG_D3D_BLOCKONTIME_4__LTCG_EAX1_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3D_MAKEREQUESTEDSPACE_4__LTCG_EAX2_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x005A, 0x81),
    ov!(0x005B, 0xC5),
...
static D3D8_LTCG_D3D_MAKEREQUESTEDSPACE_4__LTCG_EAX2_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_ENABLEOVERLAY_0__LTCG_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x80),
    ov!(0x001C, 0x00),
...
static D3D8_LTCG_D3DDEVICE_ENABLEOVERLAY_0__LTCG_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_LOADVERTEXSHADER_0__LTCG_EDX1_EAX2_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x0D),
    ov!(0x0060, 0xC7),
    ov!(0x0061, 0x00),
...
static D3D8_LTCG_D3DDEVICE_LOADVERTEXSHADER_0__LTCG_EDX1_EAX2_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4F_16__LTCG_EDI1_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0022, 0xB9),
    ov!(0x0023, 0x18),
...
static D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4F_16__LTCG_EDI1_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_16__LTCG_EAX2_2048_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0002, 0x0C),
    ov!(0x00C9, 0x77),
...
static D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_16__LTCG_EAX2_2048_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_TEXCOORDINDEX_4__LTCG_ESI1_2052_ENTRIES:
    &[OovpaEntry] = &[
    ov!(0x0000, 0x51),
    ov!(0x0001, 0x53),
    ov!(0x0040, 0x81),
...
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_TEXCOORDINDEX_4__LTCG_ESI1_2052_XREFS: &[OovpaXref] =
    &[OovpaXref {
        offset: 0x0015,
        target: "D3DTSS_TEXCOORDINDEX",
    }];
...
// Source: D3D8LTCG/5028.inl
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_TEXCOORDINDEX_4__LTCG_ESI1_2058_ENTRIES:
    &[OovpaEntry] = &[
    ov!(0x0001, 0x53),
    ov!(0x0002, 0x8B),
    ov!(0x0008, 0x55),
...
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_TEXCOORDINDEX_4__LTCG_ESI1_2058_XREFS: &[OovpaXref] =
    &[OovpaXref {
        offset: 0x0014,
        target: "D3DTSS_TEXCOORDINDEX",
    }];
...
// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SETSTREAMSOURCE_0__LTCG_EAX1_EDI2_EBX3_2058_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x85),
    ov!(0x0001, 0xFF),
    ov!(0x0002, 0x8B),
    ov!(0x0003, 0x0D),
...
static D3D8_LTCG_D3DDEVICE_SETSTREAMSOURCE_0__LTCG_EAX1_EDI2_EBX3_2058_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0019,
        target: "D3D_g_Stream_i_pVertexBuffer",
    },
...
// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x85),
    ov!(0x0001, 0xC0),
    ov!(0x0003, 0x8B),
    ov!(0x005C, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3D_BLOCKONTIME_4__LTCG_EAX1_2060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x00F4, 0xC7),
    ov!(0x00F5, 0x47),
    ov!(0x00F6, 0x10),
...
static D3D8_LTCG_D3D_BLOCKONTIME_4__LTCG_EAX1_2060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_DIRECT3D_CREATEDEVICE_4__LTCG_EAX1_ECX3_2060_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x000B, 0x85),
    ov!(0x000C, 0xC9),
    ov!(0x000D, 0x75),
...
static D3D8_LTCG_DIRECT3D_CREATEDEVICE_4__LTCG_EAX1_ECX3_2060_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2061_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x85),
    ov!(0x0001, 0xC0),
    ov!(0x0003, 0x8B),
    ov!(0x006E, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2061_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2062_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x85),
    ov!(0x0001, 0xC0),
    ov!(0x0003, 0x8B),
    ov!(0x006F, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2062_XREFS: &[OovpaXref] = &[];
...
// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2072_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x85),
    ov!(0x0001, 0xC0),
    ov!(0x0003, 0x8B),
    ov!(0x0061, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2072_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2084_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x85),
    ov!(0x0001, 0xC0),
    ov!(0x0003, 0x8B),
    ov!(0x005D, 0xC7),
...
static D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2084_XREFS: &[OovpaXref] = &[];
...
// Source: D3D8LTCG/5028.inl
static D3D8_LTCG_CDEVICE_KICKOFF_4_5028_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x44),
    ov!(0x0002, 0x24),
    ov!(0x0003, 0x04),
...
static D3D8_LTCG_CDEVICE_KICKOFF_4_5028_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5120.inl
static D3D8_LTCG_D3DDEVICE_COPYRECTS_5120_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0006, 0x8B),
    ov!(0x0007, 0x74),
...
static D3D8_LTCG_D3DDEVICE_COPYRECTS_5120_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5120.inl
static D3D8_LTCG_D3DDEVICE_RESET_5120_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0033, 0x75),
    ov!(0x0036, 0xE8),
    ov!(0x003B, 0x8B),
...
static D3D8_LTCG_D3DDEVICE_RESET_5120_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0037,
    target: "D3D_CDevice_FreeFrameBuffers",
}];

// Source: D3D8LTCG/5120.inl
static D3D8_LTCG_D3DDEVICE_COPYRECTS_5121_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0006, 0x8B),
    ov!(0x0007, 0x74),
...
static D3D8_LTCG_D3DDEVICE_COPYRECTS_5121_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_GETBACKBUFFER2_0__LTCG_EAX1_5233_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xF8),
    ov!(0x0002, 0xFF),
    ov!(0x0009, 0x75),
...
static D3D8_LTCG_D3DDEVICE_GETBACKBUFFER2_0__LTCG_EAX1_5233_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0005,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5233.inl
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_COLORKEYCOLOR_0__LTCG_EAX1_EBX2_5233_ENTRIES:
    &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x000B, 0x8B),
    ov!(0x000C, 0xF0),
...
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_COLORKEYCOLOR_0__LTCG_EAX1_EBX2_5233_XREFS:
    &[OovpaXref] = &[];

// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_DELETEVERTEXSHADER_0__LTCG_EAX1_5344_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x48),
    ov!(0x0002, 0xFF),
    ov!(0x0003, 0x48),
...
static D3D8_LTCG_D3DDEVICE_DELETEVERTEXSHADER_0__LTCG_EAX1_5344_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_RESET_0__LTCG_EBX1_5344_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0033, 0x75),
    ov!(0x0036, 0xE8),
    ov!(0x003B, 0x53),
];
static D3D8_LTCG_D3DDEVICE_RESET_0__LTCG_EBX1_5344_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0037,
    target: "D3D_CDevice_FreeFrameBuffers",
}];

// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5344_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x1D),
    ov!(0x0009, 0x8D),
...
static D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5344_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5344.inl
static D3D8_LTCG_D3D_COMMONSETMULTISAMPLEMODEANDSCALE_4__LTCG_EAX1_5344_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0002, 0x0C),
    ov!(0x0006, 0x8B),
...
static D3D8_LTCG_D3D_COMMONSETMULTISAMPLEMODEANDSCALE_4__LTCG_EAX1_5344_XREFS: &[OovpaXref] =
    &[OovpaXref {
        offset: 0x0029,
        target: "D3DRS_MultiSampleMode",
    }];
...
// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_CDEVICE_INITIALIZEFRAMEBUFFERS_4__LTCG_EDI1_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0018, 0x72),
    ov!(0x0019, 0x04),
...
static D3D8_LTCG_CDEVICE_INITIALIZEFRAMEBUFFERS_4__LTCG_EDI1_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_CDEVICE_KICKOFF_0__LTCG_EAX1_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x48),
    ov!(0x0002, 0x08),
    ov!(0x0003, 0xF6),
...
static D3D8_LTCG_CDEVICE_KICKOFF_0__LTCG_EAX1_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x1D),
    ov!(0x0009, 0x8D),
...
static D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5455_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3D_BLOCKONRESOURCE_0__LTCG_EAX1_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x000F, 0x8B),
    ov!(0x0010, 0x10),
...
static D3D8_LTCG_D3D_BLOCKONRESOURCE_0__LTCG_EAX1_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_EAX1_ECX2_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0002, 0x18),
    ov!(0x0006, 0x8B),
...
static D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_EAX1_ECX2_5455_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0008,
    target: "D3D_g_pDevice",
}];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x1D),
    ov!(0x000A, 0xC1),
...
static D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5558_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8LTCG/5455.inl
static D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_EAX1_ECX2_5659_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0002, 0x1C),
    ov!(0x0006, 0x8B),
...
static D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_EAX1_ECX2_5659_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0008,
    target: "D3D_g_pDevice",
}];

// Source: D3D8LTCG/5788.inl
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_COLORKEYCOLOR_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0007, 0x8B),
    ov!(0x0009, 0x3B),
    ov!(0x000A, 0x46),
...
static D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_COLORKEYCOLOR_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8LTCG/5849.inl
static D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_ECX1_EAX2_5849_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0002, 0x18),
    ov!(0x0008, 0x8B),
...
static D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_ECX1_EAX2_5849_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x000A,
    target: "D3D_g_pDevice",
}];
...
pub const PATTERNS: &[OovpaPattern] = &[
    ...
    OovpaPattern {
        ...
        detect_size: 0x002D,
        entries: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADERDIRECT_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x002C,
        entries: D3D8_LTCG_D3DDEVICE_SETLIGHT_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x001B,
        entries: D3D8_LTCG_D3DDEVICE_SETSCREENSPACEOFFSET_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x00D3,
        entries: D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_1024_ENTRIES,
        argc: 4,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        name: "D3DDevice_SetPalette",
        detect_size: 0x0020,
        entries: D3D8_LTCG_D3DDEVICE_SETPALETTE_1024_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x0081,
        entries: D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x001F,
        entries: D3D8_LTCG_D3DDEVICE_SETPIXELSHADERPROGRAM_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderTargetFast",
        detect_size: 0x000E,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERTARGETFAST_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x00BC,
        entries: D3D8_LTCG_D3D_BLOCKONTIME_1024_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x004D,
        entries: D3D8_LTCG_D3DDEVICE_BEGINPUSHBUFFER_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x002C,
        entries: D3D8_LTCG_D3DDEVICE_CREATEPIXELSHADER_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        name: "D3DDevice_End",
        detect_size: 0x0044,
        entries: D3D8_LTCG_D3DDEVICE_END_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x001A,
        entries: D3D8_LTCG_D3DDEVICE_GETVIEWPORTOFFSETANDSCALE_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x000C,
        entries: D3D8_LTCG_D3DDEVICE_LOADVERTEXSHADERPROGRAM_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x001A,
        entries: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_1024_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x0018,
        entries: D3D8_LTCG_D3DRESOURCE_RELEASE_1024_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    OovpaPattern {
        ...
        detect_size: 0x0040,
        entries: D3D8_LTCG_GET2DSURFACEDESC_1024_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1024,
    },
    ...
    OovpaPattern {
        name: "Direct3D_CreateDevice",
        detect_size: 0x0017,
        entries: D3D8_LTCG_DIRECT3D_CREATEDEVICE_1036_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1036,
    },
    OovpaPattern {
        name: "D3DDevice_BeginPush",
        detect_size: 0x001E,
        entries: D3D8_LTCG_D3DDEVICE_BEGINPUSH_4_1036_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1036,
    },
    OovpaPattern {
        name: "D3DDevice_SetPalette",
        detect_size: 0x001F,
        entries: D3D8_LTCG_D3DDEVICE_SETPALETTE_1036_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1036,
    },
    OovpaPattern {
        name: "D3DDevice_LightEnable",
        detect_size: 0x002A,
        entries: D3D8_LTCG_D3DDEVICE_LIGHTENABLE_1036_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1036,
    },
    OovpaPattern {
        name: "D3DDevice_Begin",
        detect_size: 0x003E,
        entries: D3D8_LTCG_D3DDEVICE_BEGIN_1036_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1036,
    },
    OovpaPattern {
        name: "D3DDevice_SetVertexData4f",
        detect_size: 0x002D,
        entries: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4F_1036_ENTRIES,
        argc: 4,
        hle_mode: HleMode::Hle,
        min_version: 1036,
    },
    OovpaPattern {
        name: "D3D_KickOffAndWaitForIdle2",
        detect_size: 0x001E,
        entries: D3D8_LTCG_D3D_KICKOFFANDWAITFORIDLE2_1036_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1036,
    },
    OovpaPattern {
        ...
        detect_size: 0x0060,
        entries: D3D8_LTCG_D3D_MAKEREQUESTEDSPACE_8_1036_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1036,
    },
    ...
    OovpaPattern {
        name: "D3D_CommonSetRenderTarget",
        detect_size: 0x0062,
        entries: D3D8_LTCG_D3D_COMMONSETRENDERTARGET_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_SetPalette",
        detect_size: 0x001A,
        entries: D3D8_LTCG_D3DDEVICE_SETPALETTE_1048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_DrawIndexedVerticesUP",
        detect_size: 0x0017,
        entries: D3D8_LTCG_D3DDEVICE_DRAWINDEXEDVERTICESUP_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_DrawVerticesUP",
        detect_size: 0x0017,
        entries: D3D8_LTCG_D3DDEVICE_DRAWVERTICESUP_1048_ENTRIES,
        argc: 3,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_End",
        detect_size: 0x004A,
        entries: D3D8_LTCG_D3DDEVICE_END_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_SetScissors",
        detect_size: 0x001F,
        entries: D3D8_LTCG_D3DDEVICE_SETSCISSORS_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        ...
        detect_size: 0x0096,
        entries: D3D8_LTCG_CDEVICE_KICKOFF_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_SetViewport",
        detect_size: 0x000B,
        entries: D3D8_LTCG_D3DDEVICE_SETVIEWPORT_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3D_KickOffAndWaitForIdle2",
        detect_size: 0x0022,
        entries: D3D8_LTCG_D3D_KICKOFFANDWAITFORIDLE2_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_RunPushBuffer",
        detect_size: 0x0054,
        entries: D3D8_LTCG_D3DDEVICE_RUNPUSHBUFFER_1048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_SetTextureState_BorderColor",
        detect_size: 0x002A,
        entries: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_BORDERCOLOR_1048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3D_SetFence",
        detect_size: 0x0029,
        entries: D3D8_LTCG_D3D_SETFENCE_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_BeginVisibilityTest",
        detect_size: 0x0037,
        entries: D3D8_LTCG_D3DDEVICE_BEGINVISIBILITYTEST_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_SetPixelShader",
        detect_size: 0x001E,
        entries: D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_SetVertexData2f",
        detect_size: 0x0040,
        entries: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA2F_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_SetVertexData2s",
        detect_size: 0x0028,
        entries: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA2S_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_SetVertexData4s",
        detect_size: 0x003A,
        entries: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4S_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_SetVertexData4ub",
        detect_size: 0x0029,
        entries: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4UB_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3DDevice_Swap",
        detect_size: 0x002F,
        entries: D3D8_LTCG_D3DDEVICE_SWAP_1048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    OovpaPattern {
        name: "D3D_BlockOnTime",
        detect_size: 0x00F8,
        entries: D3D8_LTCG_D3D_BLOCKONTIME_1048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 1048,
    },
    ...
    OovpaPattern {
        name: "D3DDevice_SetRenderState_CullMode",
        detect_size: 0x0039,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_CULLMODE_1053_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1053,
    },
    ...
    OovpaPattern {
        name: "D3D_CommonSetRenderTarget",
        detect_size: 0x0065,
        entries: D3D8_LTCG_D3D_COMMONSETRENDERTARGET_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_TwoSidedLighting",
        detect_size: 0x003D,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetViewport",
        detect_size: 0x0145,
        entries: D3D8_LTCG_D3DDEVICE_SETVIEWPORT_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_EdgeAntiAlias",
        detect_size: 0x002A,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_EDGEANTIALIAS_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_FillMode",
        detect_size: 0x004D,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FILLMODE_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_FogColor",
        detect_size: 0x002A,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FOGCOLOR_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_FrontFace",
        detect_size: 0x003B,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FRONTFACE_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_LogicOp",
        detect_size: 0x0039,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_LOGICOP_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_NormalizeNormals",
        detect_size: 0x002A,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_NORMALIZENORMALS_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_ShadowFunc",
        detect_size: 0x0029,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_SHADOWFUNC_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_StencilEnable",
        detect_size: 0x008A,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_STENCILENABLE_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_StencilFail",
        detect_size: 0x0073,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_STENCILFAIL_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_ZEnable",
        detect_size: 0x0042,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_ZENABLE_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3D_SetFence",
        detect_size: 0x002C,
        entries: D3D8_LTCG_D3D_SETFENCE_1060_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_UpdateOverlay",
        detect_size: 0x010E,
        entries: D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_1060_ENTRIES,
        argc: 4,
        hle_mode: HleMode::Hle,
        min_version: 1060,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_TwoSidedLighting",
        detect_size: 0x003E,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1061_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1061,
    },
    ...
    OovpaPattern {
        name: "D3DDevice_SetRenderTarget",
        detect_size: 0x0033,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_1072_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1072,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderTarget",
        detect_size: 0x0032,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_1084_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1084,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_TwoSidedLighting",
        detect_size: 0x0029,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1084_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 1084,
    },
    ...
    OovpaPattern {
        name: "D3DDevice_SetPalette",
        detect_size: 0x001D,
        entries: D3D8_LTCG_D3DDEVICE_SETPALETTE_4__LTCG_EAX1_2024_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2024,
    },
    OovpaPattern {
        name: "D3DDevice_SetPixelShaderConstant",
        detect_size: 0x0057,
        entries: D3D8_LTCG_D3DDEVICE_SETPIXELSHADERCONSTANT_4__LTCG_ECX1_EAX3_2024_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2024,
    },
    ...
    OovpaPattern {
        name: "D3DDevice_SetTextureState_BorderColor",
        detect_size: 0x0042,
        entries: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_BORDERCOLOR_0__LTCG_EAX1_EBX2_2036_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2036,
    },
    OovpaPattern {
        name: "D3DDevice_SetVertexShader",
        detect_size: 0x0024,
        entries: D3D8_LTCG_D3DDEVICE_SETVERTEXSHADER_0__LTCG_EBX1_2036_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 2036,
    },
    ...
    OovpaPattern {
        name: "Direct3D_CreateDevice",
        detect_size: 0x001C,
        entries: D3D8_LTCG_DIRECT3D_CREATEDEVICE_16__LTCG_EAX4_ECX6_2048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_SelectVertexShader",
        detect_size: 0x0090,
        entries: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_SelectVertexShaderDirect",
        detect_size: 0x000C,
        entries: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADERDIRECT_0__LTCG_EAX1_EBX2_2048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderTarget",
        detect_size: 0x000D,
        entries: D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_0__LTCG_ECX1_EAX2_2048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        ...
        detect_size: 0x0010,
        entries:
            D3D8_LTCG_D3DDEVICE_SETVERTEXSHADERCONSTANTNOTINLINE_0__LTCG_EBX1_EDX2_EAX3_2048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_LightEnable",
        detect_size: 0x0028,
        entries: D3D8_LTCG_D3DDEVICE_LIGHTENABLE_4__LTCG_EAX1_2048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_SetPixelShader",
        detect_size: 0x0082,
        entries: D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_0__LTCG_EAX1_2048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3D_BlockOnTime",
        detect_size: 0x00C0,
        entries: D3D8_LTCG_D3D_BLOCKONTIME_4__LTCG_EAX1_2048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3D_MakeRequestedSpace",
        detect_size: 0x0062,
        entries: D3D8_LTCG_D3D_MAKEREQUESTEDSPACE_4__LTCG_EAX2_2048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_EnableOverlay_0__LTCG",
        detect_size: 0x0061,
        entries: D3D8_LTCG_D3DDEVICE_ENABLEOVERLAY_0__LTCG_2048_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_LoadVertexShader",
        detect_size: 0x0067,
        entries: D3D8_LTCG_D3DDEVICE_LOADVERTEXSHADER_0__LTCG_EDX1_EAX2_2048_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_SetVertexData4f",
        detect_size: 0x0029,
        entries: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4F_16__LTCG_EDI1_2048_ENTRIES,
        argc: 4,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_UpdateOverlay",
        detect_size: 0x00D1,
        entries: D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_16__LTCG_EAX2_2048_ENTRIES,
        argc: 4,
        hle_mode: HleMode::Hle,
        min_version: 2048,
    },
    OovpaPattern {
        name: "D3DDevice_SetTextureState_TexCoordIndex",
        detect_size: 0x0048,
        entries: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_TEXCOORDINDEX_4__LTCG_ESI1_2052_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2052,
    },
    OovpaPattern {
        name: "D3DDevice_SetTextureState_TexCoordIndex",
        detect_size: 0x0018,
        entries: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_TEXCOORDINDEX_4__LTCG_ESI1_2058_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2058,
    },
    OovpaPattern {
        name: "D3DDevice_SetStreamSource",
        detect_size: 0x004D,
        entries: D3D8_LTCG_D3DDEVICE_SETSTREAMSOURCE_0__LTCG_EAX1_EDI2_EBX3_2058_ENTRIES,
        argc: 2,
        hle_mode: HleMode::Hle,
        min_version: 2058,
    },
    ...
    OovpaPattern {
        name: "D3DDevice_SelectVertexShader",
        detect_size: 0x00A0,
        entries: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2060_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2060,
    },
    OovpaPattern {
        name: "D3D_BlockOnTime",
        detect_size: 0x00FC,
        entries: D3D8_LTCG_D3D_BLOCKONTIME_4__LTCG_EAX1_2060_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2060,
    },
    OovpaPattern {
        name: "Direct3D_CreateDevice",
        detect_size: 0x003C,
        entries: D3D8_LTCG_DIRECT3D_CREATEDEVICE_4__LTCG_EAX1_ECX3_2060_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2060,
    },
    OovpaPattern {
        name: "D3DDevice_SelectVertexShader",
        detect_size: 0x00B2,
        entries: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2061_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2061,
    },
    OovpaPattern {
        name: "D3DDevice_SelectVertexShader",
        detect_size: 0x00B4,
        entries: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2062_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2062,
    },
    ...
    OovpaPattern {
        name: "D3DDevice_SelectVertexShader",
        detect_size: 0x00A6,
        entries: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2072_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2072,
    },
    OovpaPattern {
        name: "D3DDevice_SelectVertexShader",
        detect_size: 0x00A2,
        entries: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2084_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 2084,
    },
    ...
    OovpaPattern {
        name: "CDevice_KickOff",
        detect_size: 0x00AF,
        entries: D3D8_LTCG_CDEVICE_KICKOFF_4_5028_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5028,
    },
    OovpaPattern {
        name: "D3DDevice_CopyRects",
        detect_size: 0x0010,
        entries: D3D8_LTCG_D3DDEVICE_COPYRECTS_5120_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5120,
    },
    OovpaPattern {
        name: "D3DDevice_Reset",
        detect_size: 0x003F,
        entries: D3D8_LTCG_D3DDEVICE_RESET_5120_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5120,
    },
    OovpaPattern {
        name: "D3DDevice_CopyRects",
        detect_size: 0x0011,
        entries: D3D8_LTCG_D3DDEVICE_COPYRECTS_5121_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5121,
    },
    OovpaPattern {
        name: "D3DDevice_GetBackBuffer2",
        detect_size: 0x0047,
        entries: D3D8_LTCG_D3DDEVICE_GETBACKBUFFER2_0__LTCG_EAX1_5233_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5233,
    },
    OovpaPattern {
        name: "D3DDevice_SetTextureState_ColorKeyColor",
        detect_size: 0x003E,
        entries: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_COLORKEYCOLOR_0__LTCG_EAX1_EBX2_5233_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 5233,
    },
    OovpaPattern {
        name: "D3DDevice_DeleteVertexShader",
        detect_size: 0x0015,
        entries: D3D8_LTCG_D3DDEVICE_DELETEVERTEXSHADER_0__LTCG_EAX1_5344_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5344,
    },
    OovpaPattern {
        name: "D3DDevice_Reset",
        detect_size: 0x003C,
        entries: D3D8_LTCG_D3DDEVICE_RESET_0__LTCG_EBX1_5344_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5344,
    },
    OovpaPattern {
        name: "D3DDevice_SetTransform",
        detect_size: 0x0100,
        entries: D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5344_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5344,
    },
    OovpaPattern {
        ...
        detect_size: 0x004E,
        entries: D3D8_LTCG_D3D_COMMONSETMULTISAMPLEMODEANDSCALE_4__LTCG_EAX1_5344_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 5344,
    },
    OovpaPattern {
        name: "CDevice_InitializeFrameBuffers",
        detect_size: 0x0176,
        entries: D3D8_LTCG_CDEVICE_INITIALIZEFRAMEBUFFERS_4__LTCG_EDI1_5455_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "CDevice_KickOff",
        detect_size: 0x0099,
        entries: D3D8_LTCG_CDEVICE_KICKOFF_0__LTCG_EAX1_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_SetTransform",
        detect_size: 0x010A,
        entries: D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3D_BlockOnResource",
        detect_size: 0x002F,
        entries: D3D8_LTCG_D3D_BLOCKONRESOURCE_0__LTCG_EAX1_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3D_SetTileNoWait",
        detect_size: 0x0071,
        entries: D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_EAX1_ECX2_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_SetTransform",
        detect_size: 0x010E,
        entries: D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3D_SetTileNoWait",
        detect_size: 0x006E,
        entries: D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_EAX1_ECX2_5659_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5659,
    },
    OovpaPattern {
        name: "D3DDevice_SetTextureState_ColorKeyColor",
        detect_size: 0x0042,
        entries: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_COLORKEYCOLOR_5788_ENTRIES,
        argc: 1,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3D_SetTileNoWait",
        detect_size: 0x0072,
        entries: D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_ECX1_EAX2_5849_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5849,
    },
...
pub const METADATA: &[OovpaPatternMeta] = &[
    ...
    OovpaPatternMeta {
        name: "D3DDevice_SelectVertexShaderDirect",
        min_version: 1024,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADERDIRECT_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetLight",
        min_version: 1024,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETLIGHT_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetScreenSpaceOffset",
        min_version: 1024,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETSCREENSPACEOFFSET_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_UpdateOverlay",
        min_version: 1024,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPalette",
        min_version: 1024,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETPALETTE_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPixelShader",
        min_version: 1024,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPixelShaderProgram",
        min_version: 1024,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETPIXELSHADERPROGRAM_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderTargetFast",
        min_version: 1024,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERTARGETFAST_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_BlockOnTime",
        min_version: 1024,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3D_BLOCKONTIME_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_BeginPushBuffer",
        min_version: 1024,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_BEGINPUSHBUFFER_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_CreatePixelShader",
        min_version: 1024,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_CREATEPIXELSHADER_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_End",
        min_version: 1024,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_END_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetViewportOffsetAndScale",
        min_version: 1024,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_GETVIEWPORTOFFSETANDSCALE_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_LoadVertexShaderProgram",
        min_version: 1024,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_LOADVERTEXSHADERPROGRAM_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SelectVertexShader",
        min_version: 1024,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DResource_Release",
        min_version: 1024,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DRESOURCE_RELEASE_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "Get2DSurfaceDesc",
        min_version: 1024,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_GET2DSURFACEDESC_1024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_Clear",
        min_version: 1036,
    ...
    OovpaPatternMeta {
        name: "Direct3D_CreateDevice",
        min_version: 1036,
        source_file: "D3D8LTCG/5120.inl",
        xrefs: D3D8_LTCG_DIRECT3D_CREATEDEVICE_1036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_BeginPush",
        min_version: 1036,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_BEGINPUSH_4_1036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPalette",
        min_version: 1036,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETPALETTE_1036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_LightEnable",
        min_version: 1036,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_LIGHTENABLE_1036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_Begin",
        min_version: 1036,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_BEGIN_1036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetVertexData4f",
        min_version: 1036,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4F_1036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_KickOffAndWaitForIdle2",
        min_version: 1036,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3D_KICKOFFANDWAITFORIDLE2_1036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_MakeRequestedSpace",
        min_version: 1036,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3D_MAKEREQUESTEDSPACE_8_1036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_DrawIndexedVertices",
        min_version: 1037,
    ...
    OovpaPatternMeta {
        name: "D3D_CommonSetRenderTarget",
        min_version: 1048,
        source_file: "D3D8LTCG/5028.inl",
        xrefs: D3D8_LTCG_D3D_COMMONSETRENDERTARGET_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPalette",
        min_version: 1048,
        source_file: "D3D8LTCG/5120.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETPALETTE_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_DrawIndexedVerticesUP",
        min_version: 1048,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_DRAWINDEXEDVERTICESUP_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_DrawVerticesUP",
        min_version: 1048,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_DRAWVERTICESUP_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_End",
        min_version: 1048,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_END_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetScissors",
        min_version: 1048,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETSCISSORS_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "CDevice_KickOff",
        min_version: 1048,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_CDEVICE_KICKOFF_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetViewport",
        min_version: 1048,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETVIEWPORT_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_KickOffAndWaitForIdle2",
        min_version: 1048,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3D_KICKOFFANDWAITFORIDLE2_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_RunPushBuffer",
        min_version: 1048,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_RUNPUSHBUFFER_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetTextureState_BorderColor",
        min_version: 1048,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_BORDERCOLOR_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_SetFence",
        min_version: 1048,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3D_SETFENCE_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_BeginVisibilityTest",
        min_version: 1048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_BEGINVISIBILITYTEST_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPixelShader",
        min_version: 1048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetVertexData2f",
        min_version: 1048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA2F_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetVertexData2s",
        min_version: 1048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA2S_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetVertexData4s",
        min_version: 1048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4S_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetVertexData4ub",
        min_version: 1048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4UB_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_Swap",
        min_version: 1048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SWAP_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_BlockOnTime",
        min_version: 1048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3D_BLOCKONTIME_1048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_CullMode",
        min_version: 1049,
    ...
    OovpaPatternMeta {
        ...
        min_version: 1053,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_CULLMODE_1053_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetScissors",
        min_version: 1060,
    ...
    OovpaPatternMeta {
        ...
        min_version: 1060,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3D_COMMONSETRENDERTARGET_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_TwoSidedLighting",
        min_version: 1060,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetViewport",
        min_version: 1060,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETVIEWPORT_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_EdgeAntiAlias",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_EDGEANTIALIAS_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_FillMode",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FILLMODE_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_FogColor",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FOGCOLOR_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_FrontFace",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_FRONTFACE_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_LogicOp",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_LOGICOP_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_NormalizeNormals",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_NORMALIZENORMALS_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_ShadowFunc",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_SHADOWFUNC_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_StencilEnable",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_STENCILENABLE_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_StencilFail",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_STENCILFAIL_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_ZEnable",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_ZENABLE_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_SetFence",
        min_version: 1060,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3D_SETFENCE_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_UpdateOverlay",
        min_version: 1060,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_1060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_TwoSidedLighting",
        min_version: 1061,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1061_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetScissors",
        min_version: 1072,
    ...
    OovpaPatternMeta {
        ...
        min_version: 1072,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_1072_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderTarget",
        min_version: 1084,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_1084_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_TwoSidedLighting",
        min_version: 1084,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERSTATE_TWOSIDEDLIGHTING_1084_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetTextureState_TexCoordIndex",
        min_version: 1944,
    ...
    OovpaPatternMeta {
        ...
        min_version: 2024,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETPALETTE_4__LTCG_EAX1_2024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPixelShaderConstant",
        min_version: 2024,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETPIXELSHADERCONSTANT_4__LTCG_ECX1_EAX3_2024_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_LoadVertexShader",
        min_version: 2036,
    ...
    OovpaPatternMeta {
        ...
        min_version: 2036,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_BORDERCOLOR_0__LTCG_EAX1_EBX2_2036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetVertexShader",
        min_version: 2036,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETVERTEXSHADER_0__LTCG_EBX1_2036_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetStreamSource",
        min_version: 2039,
    ...
    OovpaPatternMeta {
        ...
        min_version: 2048,
        source_file: "D3D8LTCG/5028.inl",
        xrefs: D3D8_LTCG_DIRECT3D_CREATEDEVICE_16__LTCG_EAX4_ECX6_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SelectVertexShader",
        min_version: 2048,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SelectVertexShaderDirect",
        min_version: 2048,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADERDIRECT_0__LTCG_EAX1_EBX2_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderTarget",
        min_version: 2048,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETRENDERTARGET_0__LTCG_ECX1_EAX2_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetVertexShaderConstantNotInline",
        min_version: 2048,
        source_file: "D3D8LTCG/5233.inl",
        xrefs:
            D3D8_LTCG_D3DDEVICE_SETVERTEXSHADERCONSTANTNOTINLINE_0__LTCG_EBX1_EDX2_EAX3_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_LightEnable",
        min_version: 2048,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_LIGHTENABLE_4__LTCG_EAX1_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPixelShader",
        min_version: 2048,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETPIXELSHADER_0__LTCG_EAX1_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_BlockOnTime",
        min_version: 2048,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3D_BLOCKONTIME_4__LTCG_EAX1_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_MakeRequestedSpace",
        min_version: 2048,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3D_MAKEREQUESTEDSPACE_4__LTCG_EAX2_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_EnableOverlay_0__LTCG",
        min_version: 2048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_ENABLEOVERLAY_0__LTCG_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_LoadVertexShader",
        min_version: 2048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_LOADVERTEXSHADER_0__LTCG_EDX1_EAX2_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetVertexData4f",
        min_version: 2048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETVERTEXDATA4F_16__LTCG_EDI1_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_UpdateOverlay",
        min_version: 2048,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_UPDATEOVERLAY_16__LTCG_EAX2_2048_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetTextureState_TexCoordIndex",
        min_version: 2052,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_TEXCOORDINDEX_4__LTCG_ESI1_2052_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetTextureState_TexCoordIndex",
        min_version: 2058,
        source_file: "D3D8LTCG/5028.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_TEXCOORDINDEX_4__LTCG_ESI1_2058_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetStreamSource",
        min_version: 2058,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETSTREAMSOURCE_0__LTCG_EAX1_EDI2_EBX3_2058_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPixelShader",
        min_version: 2060,
    ...
    OovpaPatternMeta {
        ...
        min_version: 2060,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_BlockOnTime",
        min_version: 2060,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3D_BLOCKONTIME_4__LTCG_EAX1_2060_XREFS,
    },
    OovpaPatternMeta {
        name: "Direct3D_CreateDevice",
        min_version: 2060,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_DIRECT3D_CREATEDEVICE_4__LTCG_EAX1_ECX3_2060_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SelectVertexShader",
        min_version: 2061,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2061_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SelectVertexShader",
        min_version: 2062,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2062_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetPixelShader",
        min_version: 2072,
    ...
    OovpaPatternMeta {
        ...
        min_version: 2072,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2072_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SelectVertexShader",
        min_version: 2084,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SELECTVERTEXSHADER_0__LTCG_EAX1_EBX2_2084_XREFS,
    },
    OovpaPatternMeta {
        name: "CDevice_FreeFrameBuffers",
        min_version: 3911,
    ...
    OovpaPatternMeta {
        ...
        min_version: 5028,
        source_file: "D3D8LTCG/5028.inl",
        xrefs: D3D8_LTCG_CDEVICE_KICKOFF_4_5028_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_CopyRects",
        min_version: 5120,
        source_file: "D3D8LTCG/5120.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_COPYRECTS_5120_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_Reset",
        min_version: 5120,
        source_file: "D3D8LTCG/5120.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_RESET_5120_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_CopyRects",
        min_version: 5121,
        source_file: "D3D8LTCG/5120.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_COPYRECTS_5121_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetBackBuffer2",
        min_version: 5233,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_GETBACKBUFFER2_0__LTCG_EAX1_5233_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetTextureState_ColorKeyColor",
        min_version: 5233,
        source_file: "D3D8LTCG/5233.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_COLORKEYCOLOR_0__LTCG_EAX1_EBX2_5233_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_DeleteVertexShader",
        min_version: 5344,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_DELETEVERTEXSHADER_0__LTCG_EAX1_5344_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_Reset",
        min_version: 5344,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_RESET_0__LTCG_EBX1_5344_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetTransform",
        min_version: 5344,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5344_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_CommonSetMultiSampleModeAndScale",
        min_version: 5344,
        source_file: "D3D8LTCG/5344.inl",
        xrefs: D3D8_LTCG_D3D_COMMONSETMULTISAMPLEMODEANDSCALE_4__LTCG_EAX1_5344_XREFS,
    },
    OovpaPatternMeta {
        name: "CDevice_InitializeFrameBuffers",
        min_version: 5455,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_CDEVICE_INITIALIZEFRAMEBUFFERS_4__LTCG_EDI1_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "CDevice_KickOff",
        min_version: 5455,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_CDEVICE_KICKOFF_0__LTCG_EAX1_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetTransform",
        min_version: 5455,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_BlockOnResource",
        min_version: 5455,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3D_BLOCKONRESOURCE_0__LTCG_EAX1_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_SetTileNoWait",
        min_version: 5455,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_EAX1_ECX2_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetTransform",
        min_version: 5558,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETTRANSFORM_0__LTCG_EAX1_EDX2_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_SetTileNoWait",
        min_version: 5659,
        source_file: "D3D8LTCG/5455.inl",
        xrefs: D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_EAX1_ECX2_5659_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetTextureState_ColorKeyColor",
        min_version: 5788,
        source_file: "D3D8LTCG/5788.inl",
        xrefs: D3D8_LTCG_D3DDEVICE_SETTEXTURESTATE_COLORKEYCOLOR_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_SetTileNoWait",
        min_version: 5849,
        source_file: "D3D8LTCG/5849.inl",
        xrefs: D3D8_LTCG_D3D_SETTILENOWAIT_0__LTCG_ECX1_EAX2_5849_XREFS,
    },
];
