...
// Source: XGraphic/4134.inl
static XGRAPHIC_XGSETINDEXBUFFERHEADER_4134_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0001, 0x44),
    ov!(0x0004, 0x8B),
    ov!(0x0007, 0x18),
    ov!(0x000A, 0x08),
...
static XGRAPHIC_XGSETINDEXBUFFERHEADER_4134_XREFS: &[OovpaXref] = &[];

// Source: XGraphic/4134.inl
static XGRAPHIC_XGSETVERTEXBUFFERHEADER_4134_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0001, 0x44),
    ov!(0x0004, 0x8B),
    ov!(0x0007, 0x18),
    ov!(0x000A, 0x08),
...
static XGRAPHIC_XGSETVERTEXBUFFERHEADER_4134_XREFS: &[OovpaXref] = &[];

// Source: XGraphic/4361.inl
static XGRAPHIC_XFONT_OPENBITMAPFONTFROMMEMORY_4361_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000B, 0x75),
    ov!(0x001A, 0x8B),
    ov!(0x0028, 0x8B),
    ov!(0x0032, 0x08),
...
static XGRAPHIC_XFONT_OPENBITMAPFONTFROMMEMORY_4361_XREFS: &[OovpaXref] = &[];
...
pub const PATTERNS: &[OovpaPattern] = &[
    ...
    OovpaPattern {
        name: "XGSetIndexBufferHeader",
        detect_size: 0x0017,
        entries: XGRAPHIC_XGSETINDEXBUFFERHEADER_4134_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4134,
    },
    OovpaPattern {
        name: "XGSetVertexBufferHeader",
        detect_size: 0x0017,
        entries: XGRAPHIC_XGSETVERTEXBUFFERHEADER_4134_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4134,
    },
    OovpaPattern {
        name: "XFONT_OpenBitmapFontFromMemory",
        detect_size: 0x0067,
        entries: XGRAPHIC_XFONT_OPENBITMAPFONTFROMMEMORY_4361_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4361,
    },
...
pub const METADATA: &[OovpaPatternMeta] = &[
    ...
    OovpaPatternMeta {
        name: "XGSetIndexBufferHeader",
        min_version: 4134,
        source_file: "XGraphic/4134.inl",
        xrefs: XGRAPHIC_XGSETINDEXBUFFERHEADER_4134_XREFS,
    },
    OovpaPatternMeta {
        name: "XGSetVertexBufferHeader",
        min_version: 4134,
        source_file: "XGraphic/4134.inl",
        xrefs: XGRAPHIC_XGSETVERTEXBUFFERHEADER_4134_XREFS,
    },
    OovpaPatternMeta {
        name: "XFONT_OpenBitmapFontFromMemory",
        min_version: 4361,
        source_file: "XGraphic/4361.inl",
        xrefs: XGRAPHIC_XFONT_OPENBITMAPFONTFROMMEMORY_4361_XREFS,
    },
];
