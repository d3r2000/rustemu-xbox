...
// Source: D3D8/5455.inl
static D3D8_CDEVICE_FREEFRAMEBUFFERS_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0001, 0x56),
    ov!(0x0002, 0x8B),
    ov!(0x0003, 0xF1),
...
static D3D8_CDEVICE_FREEFRAMEBUFFERS_5455_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0006,
        target: "KT_FUNC_AvGetSavedDataAddress",
    },
...
// Source: D3D8/5455.inl
static D3D8_CDEVICE_KICKOFF_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0xF1),
    ov!(0x0003, 0x8B),
...
static D3D8_CDEVICE_KICKOFF_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5455.inl
static D3D8_D3DDEVICE_CREATEPALETTE2_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000D, 0x8B),
    ov!(0x0016, 0x00),
    ov!(0x0023, 0x68),
    ov!(0x002E, 0x85),
...
static D3D8_D3DDEVICE_CREATEPALETTE2_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5455.inl
static D3D8_D3DDEVICE_CREATEVERTEXBUFFER2_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0008, 0xE8),
    ov!(0x0016, 0x08),
    ov!(0x0017, 0x68),
...
static D3D8_D3DDEVICE_CREATEVERTEXBUFFER2_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5455.inl
static D3D8_D3DDEVICE_GETTILE_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x0D),
    ov!(0x0013, 0x00),
    ov!(0x0014, 0x8B),
...
static D3D8_D3DDEVICE_GETTILE_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5455.inl
static D3D8_D3DDEVICE_GETVIEWPORT_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x4C),
    ov!(0x0007, 0x24),
...
static D3D8_D3DDEVICE_GETVIEWPORT_5455_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0001,
    target: "D3D_g_pDevice",
}];

// Source: D3D8/5455.inl
static D3D8_D3DDEVICE_SELECTVERTEXSHADER_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x001D, 0xBE),
    ov!(0x003F, 0x00),
    ov!(0x0040, 0x10),
...
static D3D8_D3DDEVICE_SELECTVERTEXSHADER_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5455.inl
static D3D8_D3DDEVICE_SETSCREENSPACEOFFSET_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xD9),
    ov!(0x0001, 0x44),
    ov!(0x0002, 0x24),
    ov!(0x0003, 0x04),
...
static D3D8_D3DDEVICE_SETSCREENSPACEOFFSET_5455_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x000D,
    target: "D3D_g_pDevice",
}];

// Source: D3D8/5455.inl
static D3D8_D3DDEVICE_SETVERTEXSHADER_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x001E, 0x89),
    ov!(0x003E, 0x5F),
    ov!(0x0061, 0x3B),
    ov!(0x0081, 0x00),
...
static D3D8_D3DDEVICE_SETVERTEXSHADER_5455_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0013,
    target: "D3DDevice__m_VertexShader_OFFSET",
}];

// Source: D3D8/5455.inl
static D3D8_D3DDEVICE_SETVIEWPORT_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x001E, 0x86),
    ov!(0x003E, 0x1B),
    ov!(0x005E, 0x8B),
    ov!(0x007E, 0x6D),
...
static D3D8_D3DDEVICE_SETVIEWPORT_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5455.inl
static D3D8_D3D_ALLOCCONTIGUOUSMEMORY_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x81),
    ov!(0x0001, 0x7C),
    ov!(0x0004, 0x00),
    ov!(0x0005, 0x10),
...
static D3D8_D3D_ALLOCCONTIGUOUSMEMORY_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5455.inl
static D3D8_D3D_SETTILENOWAIT_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x83),
    ov!(0x0001, 0xEC),
    ov!(0x0002, 0x1C),
    ov!(0x0003, 0x8B),
...
static D3D8_D3D_SETTILENOWAIT_5455_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_ADDREF_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x88),
    ov!(0x0007, 0x34),
...
static D3D8_D3DDEVICE_ADDREF_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_GETBACKMATERIAL_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0005, 0x56),
    ov!(0x0006, 0x57),
    ov!(0x000A, 0x0C),
    ov!(0x000D, 0x34),
...
static D3D8_D3DDEVICE_GETBACKMATERIAL_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_GETMATERIAL_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0005, 0x56),
    ov!(0x0006, 0x57),
    ov!(0x000A, 0x0C),
    ov!(0x000D, 0xF0),
...
static D3D8_D3DDEVICE_GETMATERIAL_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_GETPIXELSHADER_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x88),
    ov!(0x0007, 0x80),
...
static D3D8_D3DDEVICE_GETPIXELSHADER_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_GETPROJECTIONVIEWPORTMATRIX_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0002, 0x35),
    ov!(0x0007, 0x57),
    ov!(0x000F, 0x09),
    ov!(0x0010, 0x00),
...
static D3D8_D3DDEVICE_GETPROJECTIONVIEWPORTMATRIX_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_GETSHADERCONSTANTMODE_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x88),
    ov!(0x0007, 0x18),
...
static D3D8_D3DDEVICE_GETSHADERCONSTANTMODE_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_GETVERTEXSHADER_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x88),
    ov!(0x0007, 0x94),
...
static D3D8_D3DDEVICE_GETVERTEXSHADER_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_GETVIEWPORTOFFSETANDSCALE_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x001E, 0xD8),
    ov!(0x0040, 0xD8),
    ov!(0x005E, 0xC9),
    ov!(0x008C, 0x0E),
...
static D3D8_D3DDEVICE_GETVIEWPORTOFFSETANDSCALE_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_RUNPUSHBUFFER_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000E, 0xED),
    ov!(0x0042, 0x18),
    ov!(0x0062, 0x04),
    ov!(0x008D, 0x1C),
...
static D3D8_D3DDEVICE_RUNPUSHBUFFER_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_SETBACKMATERIAL_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0004, 0x08),
    ov!(0x000C, 0x81),
    ov!(0x000D, 0xC7),
    ov!(0x000E, 0x34),
...
static D3D8_D3DDEVICE_SETBACKMATERIAL_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_SETGAMMARAMP_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000F, 0x68),
    ov!(0x0020, 0x34),
    ov!(0x0031, 0xB4),
    ov!(0x0042, 0x08),
...
static D3D8_D3DDEVICE_SETGAMMARAMP_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_SETMATERIAL_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0004, 0x08),
    ov!(0x000C, 0x81),
    ov!(0x000D, 0xC7),
    ov!(0x000E, 0xF0),
...
static D3D8_D3DDEVICE_SETMATERIAL_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3DDEVICE_SETSCISSORS_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x001D, 0x44),
    ov!(0x003C, 0x8B),
    ov!(0x005D, 0xD9),
    ov!(0x007D, 0xD8),
...
static D3D8_D3DDEVICE_SETSCISSORS_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3D_BLOCKONTIME_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0002, 0x35),
    ov!(0x0008, 0x46),
    ov!(0x0009, 0x30),
    ov!(0x001F, 0x83),
...
static D3D8_D3D_BLOCKONTIME_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3D_MAKEREQUESTEDSPACE_8_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x51),
    ov!(0x0001, 0x56),
    ov!(0x0008, 0xF6),
    ov!(0x0009, 0x46),
...
static D3D8_D3D_MAKEREQUESTEDSPACE_8_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5558.inl
static D3D8_D3D_SETFENCE_5558_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0007, 0x8B),
    ov!(0x0009, 0x3B),
    ov!(0x000A, 0x46),
    ov!(0x000B, 0x04),
...
static D3D8_D3D_SETFENCE_5558_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5788.inl
static D3D8_D3DDEVICE_ADDREF_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x88),
    ov!(0x0007, 0x38),
...
static D3D8_D3DDEVICE_ADDREF_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5788.inl
static D3D8_D3DDEVICE_GETBACKMATERIAL_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0005, 0x56),
    ov!(0x0006, 0x57),
    ov!(0x000A, 0x0C),
    ov!(0x000D, 0x44),
...
static D3D8_D3DDEVICE_GETBACKMATERIAL_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5788.inl
static D3D8_D3DDEVICE_GETMATERIAL_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0005, 0x56),
    ov!(0x0006, 0x57),
    ov!(0x000A, 0x0C),
    ov!(0x000D, 0x00),
...
static D3D8_D3DDEVICE_GETMATERIAL_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5788.inl
static D3D8_D3DDEVICE_GETPIXELSHADER_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x88),
    ov!(0x0007, 0x84),
...
static D3D8_D3DDEVICE_GETPIXELSHADER_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5788.inl
static D3D8_D3DDEVICE_GETSHADERCONSTANTMODE_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x88),
    ov!(0x0007, 0x28),
...
static D3D8_D3DDEVICE_GETSHADERCONSTANTMODE_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5788.inl
static D3D8_D3DDEVICE_GETVERTEXSHADER_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0005, 0x8B),
    ov!(0x0006, 0x88),
    ov!(0x0007, 0x98),
...
static D3D8_D3DDEVICE_GETVERTEXSHADER_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5788.inl
static D3D8_D3DDEVICE_SETBACKMATERIAL_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0004, 0x08),
    ov!(0x000C, 0x81),
    ov!(0x000D, 0xC7),
    ov!(0x000E, 0x44),
...
static D3D8_D3DDEVICE_SETBACKMATERIAL_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5788.inl
static D3D8_D3DDEVICE_SETMATERIAL_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0004, 0x08),
    ov!(0x000C, 0x81),
    ov!(0x000D, 0xC7),
    ov!(0x000E, 0x00),
...
static D3D8_D3DDEVICE_SETMATERIAL_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5788.inl
static D3D8_D3D_RECORDSTATEBLOCK_5788_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000F, 0x8B),
    ov!(0x0010, 0x87),
    ov!(0x0011, 0xA4),
    ov!(0x0012, 0x07),
...
static D3D8_D3D_RECORDSTATEBLOCK_5788_XREFS: &[OovpaXref] = &[];

// Source: D3D8/5849.inl
static D3D8_D3DDEVICE_SETRENDERSTATE_STENCILENABLE_5849_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x0008, 0x8B),
...
static D3D8_D3DDEVICE_SETRENDERSTATE_STENCILENABLE_5849_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8/5849.inl
static D3D8_D3DDEVICE_SETRENDERSTATE_STENCILFAIL_5849_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x56),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0x35),
    ov!(0x0008, 0x8B),
...
static D3D8_D3DDEVICE_SETRENDERSTATE_STENCILFAIL_5849_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "D3D_g_pDevice",
    },
...
// Source: D3D8/5849.inl
static D3D8_D3D_SETFENCE_5849_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000E, 0x05),
    ov!(0x0017, 0xC7),
    ov!(0x003E, 0x40),
    ov!(0x005E, 0x00),
...
static D3D8_D3D_SETFENCE_5849_XREFS: &[OovpaXref] = &[];
...
pub const PATTERNS: &[OovpaPattern] = &[
    ...
    OovpaPattern {
        name: "CDevice_FreeFrameBuffers",
        detect_size: 0x007A,
        entries: D3D8_CDEVICE_FREEFRAMEBUFFERS_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "CDevice_KickOff",
        detect_size: 0x0076,
        entries: D3D8_CDEVICE_KICKOFF_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_CreatePalette2",
        detect_size: 0x0053,
        entries: D3D8_D3DDEVICE_CREATEPALETTE2_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_CreateVertexBuffer2",
        detect_size: 0x0045,
        entries: D3D8_D3DDEVICE_CREATEVERTEXBUFFER2_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_GetTile",
        detect_size: 0x003C,
        entries: D3D8_D3DDEVICE_GETTILE_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_GetViewport",
        detect_size: 0x0032,
        entries: D3D8_D3DDEVICE_GETVIEWPORT_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_SelectVertexShader",
        detect_size: 0x007C,
        entries: D3D8_D3DDEVICE_SELECTVERTEXSHADER_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_SetScreenSpaceOffset",
        detect_size: 0x001D,
        entries: D3D8_D3DDEVICE_SETSCREENSPACEOFFSET_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_SetVertexShader",
        detect_size: 0x00FF,
        entries: D3D8_D3DDEVICE_SETVERTEXSHADER_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_SetViewport",
        detect_size: 0x00FF,
        entries: D3D8_D3DDEVICE_SETVIEWPORT_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3D_AllocContiguousMemory",
        detect_size: 0x0032,
        entries: D3D8_D3D_ALLOCCONTIGUOUSMEMORY_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3D_SetTileNoWait",
        detect_size: 0x0076,
        entries: D3D8_D3D_SETTILENOWAIT_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "D3DDevice_AddRef",
        detect_size: 0x0010,
        entries: D3D8_D3DDEVICE_ADDREF_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_GetBackMaterial",
        detect_size: 0x001B,
        entries: D3D8_D3DDEVICE_GETBACKMATERIAL_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_GetMaterial",
        detect_size: 0x001B,
        entries: D3D8_D3DDEVICE_GETMATERIAL_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_GetPixelShader",
        detect_size: 0x0014,
        entries: D3D8_D3DDEVICE_GETPIXELSHADER_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_GetProjectionViewportMatrix",
        detect_size: 0x001C,
        entries: D3D8_D3DDEVICE_GETPROJECTIONVIEWPORTMATRIX_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_GetShaderConstantMode",
        detect_size: 0x0014,
        entries: D3D8_D3DDEVICE_GETSHADERCONSTANTMODE_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_GetVertexShader",
        detect_size: 0x0014,
        entries: D3D8_D3DDEVICE_GETVERTEXSHADER_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        ...
        detect_size: 0x00FF,
        entries: D3D8_D3DDEVICE_GETVIEWPORTOFFSETANDSCALE_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_RunPushBuffer",
        detect_size: 0x00F7,
        entries: D3D8_D3DDEVICE_RUNPUSHBUFFER_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_SetBackMaterial",
        detect_size: 0x002F,
        entries: D3D8_D3DDEVICE_SETBACKMATERIAL_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_SetGammaRamp",
        detect_size: 0x0076,
        entries: D3D8_D3DDEVICE_SETGAMMARAMP_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_SetMaterial",
        detect_size: 0x002F,
        entries: D3D8_D3DDEVICE_SETMATERIAL_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_SetScissors",
        detect_size: 0x00F7,
        entries: D3D8_D3DDEVICE_SETSCISSORS_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3D_BlockOnTime",
        detect_size: 0x00EA,
        entries: D3D8_D3D_BLOCKONTIME_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3D_MakeRequestedSpace",
        detect_size: 0x0034,
        entries: D3D8_D3D_MAKEREQUESTEDSPACE_8_5558_ENTRIES,
        argc: 2,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3D_SetFence",
        detect_size: 0x003A,
        entries: D3D8_D3D_SETFENCE_5558_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5558,
    },
    OovpaPattern {
        name: "D3DDevice_AddRef",
        detect_size: 0x0010,
        entries: D3D8_D3DDEVICE_ADDREF_5788_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3DDevice_GetBackMaterial",
        detect_size: 0x001B,
        entries: D3D8_D3DDEVICE_GETBACKMATERIAL_5788_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3DDevice_GetMaterial",
        detect_size: 0x001B,
        entries: D3D8_D3DDEVICE_GETMATERIAL_5788_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3DDevice_GetPixelShader",
        detect_size: 0x0014,
        entries: D3D8_D3DDEVICE_GETPIXELSHADER_5788_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3DDevice_GetShaderConstantMode",
        detect_size: 0x0014,
        entries: D3D8_D3DDEVICE_GETSHADERCONSTANTMODE_5788_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3DDevice_GetVertexShader",
        detect_size: 0x0014,
        entries: D3D8_D3DDEVICE_GETVERTEXSHADER_5788_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3DDevice_SetBackMaterial",
        detect_size: 0x002F,
        entries: D3D8_D3DDEVICE_SETBACKMATERIAL_5788_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3DDevice_SetMaterial",
        detect_size: 0x002F,
        entries: D3D8_D3DDEVICE_SETMATERIAL_5788_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3D_RecordStateBlock",
        detect_size: 0x00D9,
        entries: D3D8_D3D_RECORDSTATEBLOCK_5788_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5788,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_StencilEnable",
        detect_size: 0x0012,
        entries: D3D8_D3DDEVICE_SETRENDERSTATE_STENCILENABLE_5849_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5849,
    },
    OovpaPattern {
        name: "D3DDevice_SetRenderState_StencilFail",
        detect_size: 0x0012,
        entries: D3D8_D3DDEVICE_SETRENDERSTATE_STENCILFAIL_5849_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5849,
    },
    OovpaPattern {
        name: "D3D_SetFence",
        detect_size: 0x00A9,
        entries: D3D8_D3D_SETFENCE_5849_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5849,
    },
...
pub const METADATA: &[OovpaPatternMeta] = &[
    ...
    OovpaPatternMeta {
        name: "CDevice_FreeFrameBuffers",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_CDEVICE_FREEFRAMEBUFFERS_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "CDevice_KickOff",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_CDEVICE_KICKOFF_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_CreatePalette2",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3DDEVICE_CREATEPALETTE2_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_CreateVertexBuffer2",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3DDEVICE_CREATEVERTEXBUFFER2_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetTile",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3DDEVICE_GETTILE_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetViewport",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3DDEVICE_GETVIEWPORT_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SelectVertexShader",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3DDEVICE_SELECTVERTEXSHADER_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetScreenSpaceOffset",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3DDEVICE_SETSCREENSPACEOFFSET_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetVertexShader",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3DDEVICE_SETVERTEXSHADER_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetViewport",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3DDEVICE_SETVIEWPORT_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_AllocContiguousMemory",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3D_ALLOCCONTIGUOUSMEMORY_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_SetTileNoWait",
        min_version: 5455,
        source_file: "D3D8/5455.inl",
        xrefs: D3D8_D3D_SETTILENOWAIT_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_AddRef",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_ADDREF_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetBackMaterial",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_GETBACKMATERIAL_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetMaterial",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_GETMATERIAL_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetPixelShader",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_GETPIXELSHADER_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetProjectionViewportMatrix",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_GETPROJECTIONVIEWPORTMATRIX_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetShaderConstantMode",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_GETSHADERCONSTANTMODE_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetVertexShader",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_GETVERTEXSHADER_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetViewportOffsetAndScale",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_GETVIEWPORTOFFSETANDSCALE_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_RunPushBuffer",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_RUNPUSHBUFFER_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetBackMaterial",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_SETBACKMATERIAL_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetGammaRamp",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_SETGAMMARAMP_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetMaterial",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_SETMATERIAL_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetScissors",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3DDEVICE_SETSCISSORS_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_BlockOnTime",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3D_BLOCKONTIME_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_MakeRequestedSpace",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3D_MAKEREQUESTEDSPACE_8_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_SetFence",
        min_version: 5558,
        source_file: "D3D8/5558.inl",
        xrefs: D3D8_D3D_SETFENCE_5558_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_AddRef",
        min_version: 5788,
        source_file: "D3D8/5788.inl",
        xrefs: D3D8_D3DDEVICE_ADDREF_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetBackMaterial",
        min_version: 5788,
        source_file: "D3D8/5788.inl",
        xrefs: D3D8_D3DDEVICE_GETBACKMATERIAL_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetMaterial",
        min_version: 5788,
        source_file: "D3D8/5788.inl",
        xrefs: D3D8_D3DDEVICE_GETMATERIAL_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetPixelShader",
        min_version: 5788,
        source_file: "D3D8/5788.inl",
        xrefs: D3D8_D3DDEVICE_GETPIXELSHADER_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetShaderConstantMode",
        min_version: 5788,
        source_file: "D3D8/5788.inl",
        xrefs: D3D8_D3DDEVICE_GETSHADERCONSTANTMODE_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_GetVertexShader",
        min_version: 5788,
        source_file: "D3D8/5788.inl",
        xrefs: D3D8_D3DDEVICE_GETVERTEXSHADER_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetBackMaterial",
        min_version: 5788,
        source_file: "D3D8/5788.inl",
        xrefs: D3D8_D3DDEVICE_SETBACKMATERIAL_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetMaterial",
        min_version: 5788,
        source_file: "D3D8/5788.inl",
        xrefs: D3D8_D3DDEVICE_SETMATERIAL_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_RecordStateBlock",
        min_version: 5788,
        source_file: "D3D8/5788.inl",
        xrefs: D3D8_D3D_RECORDSTATEBLOCK_5788_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_StencilEnable",
        min_version: 5849,
        source_file: "D3D8/5849.inl",
        xrefs: D3D8_D3DDEVICE_SETRENDERSTATE_STENCILENABLE_5849_XREFS,
    },
    OovpaPatternMeta {
        name: "D3DDevice_SetRenderState_StencilFail",
        min_version: 5849,
        source_file: "D3D8/5849.inl",
        xrefs: D3D8_D3DDEVICE_SETRENDERSTATE_STENCILFAIL_5849_XREFS,
    },
    OovpaPatternMeta {
        name: "D3D_SetFence",
        min_version: 5849,
        source_file: "D3D8/5849.inl",
        xrefs: D3D8_D3D_SETFENCE_5849_XREFS,
    },
];
