...
// Source: Xapi/3950.inl
static XAPI_XAPIINITPROCESS_3950_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0005, 0x30),
    ov!(0x0010, 0x6A),
    ov!(0x0011, 0x0C),
    ov!(0x0018, 0xF3),
...
static XAPI_XAPIINITPROCESS_3950_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4039.inl
static XAPI_XCALCULATESIGNATUREBEGIN_4034_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xA1),
    ov!(0x0001, 0x18),
    ov!(0x0002, 0x01),
    ov!(0x0003, 0x01),
...
static XAPI_XCALCULATESIGNATUREBEGIN_4034_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4134.inl
static XAPI_XMOUNTUTILITYDRIVE_4134_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0003, 0x81),
    ov!(0x0004, 0xEC),
    ov!(0x0005, 0x14),
    ov!(0x0006, 0x01),
...
static XAPI_XMOUNTUTILITYDRIVE_4134_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4134.inl
static XAPI_XSETPROCESSQUANTUMLENGTH_4134_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0001, 0xA1),
    ov!(0x0004, 0x00),
    ov!(0x0007, 0x4C),
    ov!(0x000A, 0x8B),
...
static XAPI_XSETPROCESSQUANTUMLENGTH_4134_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4242.inl
static XAPI_GETTYPEINFORMATION_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xB8),
    ov!(0x0005, 0x56),
    ov!(0x0006, 0x8B),
    ov!(0x0007, 0xD0),
...
static XAPI_GETTYPEINFORMATION_4242_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0001,
        target: "g_DeviceTypeInfoTableBegin",
    },
    OovpaXref {
        offset: 0x0009,
        target: "g_DeviceTypeInfoTableEnd",
    },
];

// Source: Xapi/4242.inl
static XAPI_GETTYPEINFORMATION2_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0005, 0xB8),
    ov!(0x000A, 0x57),
    ov!(0x000B, 0x8B),
    ov!(0x000C, 0xF8),
...
static XAPI_GETTYPEINFORMATION2_4242_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0006,
        target: "g_DeviceTypeInfoTableBegin",
    },
...
// Source: Xapi/4242.inl
static XAPI_MU_INIT_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0xEC),
    ov!(0x0003, 0x83),
...
static XAPI_MU_INIT_4242_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4242.inl
static XAPI_XFORMATUTILITYDRIVE_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0002, 0xEC),
    ov!(0x0010, 0x50),
    ov!(0x001E, 0xEC),
    ov!(0x0040, 0xF8),
...
static XAPI_XFORMATUTILITYDRIVE_4242_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4242.inl
static XAPI_XINPUTGETSTATE_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x53),
    ov!(0x0001, 0x56),
    ov!(0x000A, 0x8B),
    ov!(0x000B, 0x54),
...
static XAPI_XINPUTGETSTATE_4242_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4242.inl
static XAPI_XINPUTOPEN_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0014, 0x6A),
    ov!(0x0015, 0x57),
    ov!(0x001D, 0xEB),
    ov!(0x001E, 0x33),
...
static XAPI_XINPUTOPEN_4242_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x000C,
        target: "GetTypeInformation",
    },
    OovpaXref {
        offset: 0x0017,
        target: "SetLastError",
...
// Source: Xapi/4242.inl
static XAPI_XINPUTSETSTATE_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0004, 0x8D),
    ov!(0x0005, 0x81),
    ov!(0x0006, 0xA3),
    ov!(0x0015, 0x6A),
...
static XAPI_XINPUTSETSTATE_4242_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4242.inl
static XAPI_XMOUNTMUA_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0022, 0x8A),
    ov!(0x003E, 0x89),
    ov!(0x005E, 0x5C),
    ov!(0x007E, 0xF4),
...
static XAPI_XMOUNTMUA_4242_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x003A,
        target: "g_XapiMountedMUs",
    },
...
// Source: Xapi/4242.inl
static XAPI_XMOUNTMUROOTA_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0016, 0xBF),
    ov!(0x0022, 0x8A),
    ov!(0x0039, 0x05),
    ov!(0x0050, 0x55),
...
static XAPI_XMOUNTMUROOTA_4242_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x003A,
    target: "g_XapiMountedMUs",
}];

// Source: Xapi/4242.inl
static XAPI_XREADMUMETADATA_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0xEC),
    ov!(0x0051, 0x66),
...
static XAPI_XREADMUMETADATA_4242_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0031,
    target: "g_XapiMountedMUs",
}];

// Source: Xapi/4242.inl
static XAPI_XUNMOUNTMU_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0xEC),
    ov!(0x0074, 0x6A),
...
static XAPI_XUNMOUNTMU_4242_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x002C,
        target: "g_XapiMountedMUs",
    },
...
// Source: Xapi/4242.inl
static XAPI_XAPIINITPROCESS_4242_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0005, 0x30),
    ov!(0x000F, 0x6A),
    ov!(0x0010, 0x0C),
    ov!(0x0017, 0xF3),
...
static XAPI_XAPIINITPROCESS_4242_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4361.inl
static XAPI_CLOSEHANDLE_4361_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xFF),
    ov!(0x0001, 0x74),
    ov!(0x0002, 0x24),
    ov!(0x0003, 0x04),
...
static XAPI_CLOSEHANDLE_4361_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4361.inl
static XAPI_CREATETHREAD_4361_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000A, 0xA1),
    ov!(0x000B, 0x30),
    ov!(0x000C, 0x01),
    ov!(0x001C, 0x81),
...
static XAPI_CREATETHREAD_4361_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4361.inl
static XAPI_XAPISETUPPERTITLEDRIVELETTERS_4361_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0009, 0x8D),
    ov!(0x000A, 0x45),
    ov!(0x000B, 0xF4),
    ov!(0x0017, 0x83),
...
static XAPI_XAPISETUPPERTITLEDRIVELETTERS_4361_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4361.inl
static XAPI_MAINCRTSTARTUP_4361_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x0D),
    ov!(0x0006, 0xA1),
    ov!(0x0018, 0xA1),
...
static XAPI_MAINCRTSTARTUP_4361_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x004C,
        target: "mainXapiStartup",
    },
...
// Source: Xapi/4721.inl
static XAPI_XLAUNCHNEWIMAGEA_4721_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0003, 0x81),
    ov!(0x0004, 0xEC),
    ov!(0x0005, 0x84),
    ov!(0x0006, 0x03),
...
static XAPI_XLAUNCHNEWIMAGEA_4721_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4831.inl
static XAPI_UNHANDLEDEXCEPTIONFILTER_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x64),
    ov!(0x0001, 0xA1),
    ov!(0x0002, 0x20),
    ov!(0x0003, 0x00),
...
static XAPI_UNHANDLEDEXCEPTIONFILTER_4831_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x0020,
    target: "g_XapiCurrentTopLevelFilter",
}];

// Source: Xapi/4831.inl
static XAPI_XGETDEVICEENUMERATIONSTATUS_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0004, 0x15),
    ov!(0x000A, 0x35),
    ov!(0x0010, 0x09),
    ov!(0x0017, 0x00),
...
static XAPI_XGETDEVICEENUMERATIONSTATUS_4831_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4831.inl
static XAPI_XID_FCLOSEDEVICE_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0xEC),
    ov!(0x000A, 0xFF),
...
static XAPI_XID_FCLOSEDEVICE_4831_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4831.inl
static XAPI_XINPUTGETCAPABILITIES_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x001F, 0x0F),
    ov!(0x0037, 0x8B),
    ov!(0x0038, 0xFA),
...
static XAPI_XINPUTGETCAPABILITIES_4831_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4831.inl
static XAPI_XINPUTGETDEVICEDESCRIPTION_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0004, 0xEC),
    ov!(0x000B, 0x15),
    ov!(0x0013, 0x45),
    ov!(0x0014, 0x08),
...
static XAPI_XINPUTGETDEVICEDESCRIPTION_4831_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4831.inl
static XAPI_XINPUTGETSTATE_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000E, 0x8B),
    ov!(0x000F, 0x8A),
    ov!(0x0010, 0xA3),
    ov!(0x001A, 0x6A),
...
static XAPI_XINPUTGETSTATE_4831_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4831.inl
static XAPI_XINPUTSETLIGHTGUNCALIBRATION_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0xEC),
    ov!(0x0016, 0xF3),
...
static XAPI_XINPUTSETLIGHTGUNCALIBRATION_4831_XREFS: &[OovpaXref] = &[OovpaXref {
    offset: 0x001C,
    target: "KT_FUNC_KeRaiseIrqlToDpcLevel",
}];

// Source: Xapi/4831.inl
static XAPI_XINPUTSETSTATE_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x8B),
    ov!(0x0001, 0x4C),
    ov!(0x0002, 0x24),
    ov!(0x0003, 0x04),
...
static XAPI_XINPUTSETSTATE_4831_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4831.inl
static XAPI_XAPIINITPROCESS_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0001, 0x8B),
    ov!(0x0013, 0x6A),
    ov!(0x0014, 0x0C),
...
static XAPI_XAPIINITPROCESS_4831_XREFS: &[OovpaXref] = &[];

// Source: Xapi/4831.inl
static XAPI_MAINXAPISTARTUP_4831_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xE8),
    ov!(0x0005, 0xE8),
    ov!(0x000A, 0x64),
    ov!(0x000B, 0xA1),
...
static XAPI_MAINXAPISTARTUP_4831_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0001,
        target: "XapiInitProcess",
    },
...
// Source: Xapi/5028.inl
static XAPI_XMOUNTALTERNATETITLEA_5028_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0004, 0xEC),
    ov!(0x000F, 0x01),
    ov!(0x0010, 0x00),
    ov!(0x0011, 0x53),
...
static XAPI_XMOUNTALTERNATETITLEA_5028_XREFS: &[OovpaXref] = &[];

// Source: Xapi/5028.inl
static XAPI_XAPIINITPROCESS_5028_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0001, 0x8B),
    ov!(0x000E, 0xF6),
    ov!(0x000F, 0x68),
...
static XAPI_XAPIINITPROCESS_5028_XREFS: &[OovpaXref] = &[];

// Source: Xapi/5120.inl
static XAPI_MU_INIT_5120_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0x55),
    ov!(0x0001, 0x8B),
    ov!(0x0002, 0xEC),
    ov!(0x0003, 0x83),
...
static XAPI_MU_INIT_5120_XREFS: &[OovpaXref] = &[];

// Source: Xapi/5120.inl
static XAPI_XINITDEVICES_5120_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000E, 0x75),
    ov!(0x0020, 0xBE),
    ov!(0x002E, 0xC0),
    ov!(0x003E, 0xEC),
...
static XAPI_XINITDEVICES_5120_XREFS: &[OovpaXref] = &[];

// Source: Xapi/5344.inl
static XAPI_XLAUNCHNEWIMAGEA_5344_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0000, 0xB8),
    ov!(0x0018, 0x75),
    ov!(0x0019, 0x19),
    ov!(0x001A, 0x83),
...
static XAPI_XLAUNCHNEWIMAGEA_5344_XREFS: &[OovpaXref] = &[];

// Source: Xapi/5455.inl
static XAPI_GETTYPEINFORMATION2_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x0002, 0xB8),
    ov!(0x0007, 0x57),
    ov!(0x0008, 0x8B),
    ov!(0x0009, 0xF8),
...
static XAPI_GETTYPEINFORMATION2_5455_XREFS: &[OovpaXref] = &[
    OovpaXref {
        offset: 0x0003,
        target: "g_DeviceTypeInfoTableBegin",
    },
...
// Source: Xapi/5455.inl
static XAPI_XINPUTGETSTATE_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000D, 0x0C),
    ov!(0x001C, 0x5E),
    ov!(0x002B, 0xBB),
    ov!(0x003A, 0x80),
...
static XAPI_XINPUTGETSTATE_5455_XREFS: &[OovpaXref] = &[];

// Source: Xapi/5455.inl
static XAPI_XMOUNTALTERNATETITLEA_5455_ENTRIES: &[OovpaEntry] = &[
    ov!(0x000B, 0x08),
    ov!(0x0018, 0x0B),
    ov!(0x0019, 0x57),
    ov!(0x001A, 0x33),
...
static XAPI_XMOUNTALTERNATETITLEA_5455_XREFS: &[OovpaXref] = &[];
...
pub const PATTERNS: &[OovpaPattern] = &[
    ...
    OovpaPattern {
        name: "XapiInitProcess",
        detect_size: 0x0045,
        entries: XAPI_XAPIINITPROCESS_3950_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 3950,
    },
    OovpaPattern {
        name: "XCalculateSignatureBegin",
        detect_size: 0x0014,
        entries: XAPI_XCALCULATESIGNATUREBEGIN_4034_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4034,
    },
    OovpaPattern {
        name: "XMountUtilityDrive",
        detect_size: 0x00AD,
        entries: XAPI_XMOUNTUTILITYDRIVE_4134_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4134,
    },
    OovpaPattern {
        ...
        detect_size: 0x0014,
        entries: XAPI_XSETPROCESSQUANTUMLENGTH_4134_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4134,
    },
    OovpaPattern {
        ...
        detect_size: 0x002B,
        entries: XAPI_GETTYPEINFORMATION_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        ...
        detect_size: 0x0037,
        entries: XAPI_GETTYPEINFORMATION2_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        name: "MU_Init",
        detect_size: 0x0092,
        entries: XAPI_MU_INIT_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        ...
        detect_size: 0x006E,
        entries: XAPI_XFORMATUTILITYDRIVE_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        name: "XInputGetState",
        detect_size: 0x005C,
        entries: XAPI_XINPUTGETSTATE_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        name: "XInputOpen",
        detect_size: 0x0055,
        entries: XAPI_XINPUTOPEN_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        name: "XInputSetState",
        detect_size: 0x0035,
        entries: XAPI_XINPUTSETSTATE_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        name: "XMountMUA",
        detect_size: 0x00FF,
        entries: XAPI_XMOUNTMUA_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        name: "XMountMURootA",
        detect_size: 0x0073,
        entries: XAPI_XMOUNTMUROOTA_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        ...
        detect_size: 0x0057,
        entries: XAPI_XREADMUMETADATA_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        name: "XUnmountMU",
        detect_size: 0x007A,
        entries: XAPI_XUNMOUNTMU_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        name: "XapiInitProcess",
        detect_size: 0x0044,
        entries: XAPI_XAPIINITPROCESS_4242_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4242,
    },
    OovpaPattern {
        name: "CloseHandle",
        detect_size: 0x001D,
        entries: XAPI_CLOSEHANDLE_4361_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4361,
    },
    OovpaPattern {
        name: "CreateThread",
        detect_size: 0x006D,
        entries: XAPI_CREATETHREAD_4361_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4361,
    },
    OovpaPattern {
        ...
        detect_size: 0x0054,
        entries: XAPI_XAPISETUPPERTITLEDRIVELETTERS_4361_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4361,
    },
    OovpaPattern {
        name: "mainCRTStartup",
        detect_size: 0x0069,
        entries: XAPI_MAINCRTSTARTUP_4361_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4361,
    },
    OovpaPattern {
        name: "XLaunchNewImageA",
        detect_size: 0x00C2,
        entries: XAPI_XLAUNCHNEWIMAGEA_4721_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4721,
    },
    OovpaPattern {
        name: "UnhandledExceptionFilter",
        detect_size: 0x003B,
        entries: XAPI_UNHANDLEDEXCEPTIONFILTER_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        ...
        detect_size: 0x0029,
        entries: XAPI_XGETDEVICEENUMERATIONSTATUS_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        name: "XID_fCloseDevice",
        detect_size: 0x0037,
        entries: XAPI_XID_FCLOSEDEVICE_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        name: "XInputGetCapabilities",
        detect_size: 0x005B,
        entries: XAPI_XINPUTGETCAPABILITIES_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        ...
        detect_size: 0x0031,
        entries: XAPI_XINPUTGETDEVICEDESCRIPTION_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        name: "XInputGetState",
        detect_size: 0x006B,
        entries: XAPI_XINPUTGETSTATE_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        ...
        detect_size: 0x002C,
        entries: XAPI_XINPUTSETLIGHTGUNCALIBRATION_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        name: "XInputSetState",
        detect_size: 0x0032,
        entries: XAPI_XINPUTSETSTATE_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        name: "XapiInitProcess",
        detect_size: 0x001F,
        entries: XAPI_XAPIINITPROCESS_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        name: "mainXapiStartup",
        detect_size: 0x0056,
        entries: XAPI_MAINXAPISTARTUP_4831_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 4831,
    },
    OovpaPattern {
        name: "XMountAlternateTitleA",
        detect_size: 0x0097,
        entries: XAPI_XMOUNTALTERNATETITLEA_5028_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5028,
    },
    OovpaPattern {
        name: "XapiInitProcess",
        detect_size: 0x002A,
        entries: XAPI_XAPIINITPROCESS_5028_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5028,
    },
    OovpaPattern {
        name: "MU_Init",
        detect_size: 0x0096,
        entries: XAPI_MU_INIT_5120_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5120,
    },
    OovpaPattern {
        name: "XInitDevices",
        detect_size: 0x0071,
        entries: XAPI_XINITDEVICES_5120_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5120,
    },
    OovpaPattern {
        name: "XLaunchNewImageA",
        detect_size: 0x0042,
        entries: XAPI_XLAUNCHNEWIMAGEA_5344_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5344,
    },
    OovpaPattern {
        name: "GetTypeInformation2",
        detect_size: 0x0037,
        entries: XAPI_GETTYPEINFORMATION2_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "XInputGetState",
        detect_size: 0x0068,
        entries: XAPI_XINPUTGETSTATE_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
    OovpaPattern {
        name: "XMountAlternateTitleA",
        detect_size: 0x00D1,
        entries: XAPI_XMOUNTALTERNATETITLEA_5455_ENTRIES,
        argc: 0,
        hle_mode: HleMode::Hle,
        min_version: 5455,
    },
...
pub const METADATA: &[OovpaPatternMeta] = &[
    ...
    OovpaPatternMeta {
        name: "XapiInitProcess",
        min_version: 3950,
        source_file: "Xapi/3950.inl",
        xrefs: XAPI_XAPIINITPROCESS_3950_XREFS,
    },
    OovpaPatternMeta {
        name: "XCalculateSignatureBegin",
        min_version: 4034,
        source_file: "Xapi/4039.inl",
        xrefs: XAPI_XCALCULATESIGNATUREBEGIN_4034_XREFS,
    },
    OovpaPatternMeta {
        name: "XMountUtilityDrive",
        min_version: 4134,
        source_file: "Xapi/4134.inl",
        xrefs: XAPI_XMOUNTUTILITYDRIVE_4134_XREFS,
    },
    OovpaPatternMeta {
        name: "XSetProcessQuantumLength",
        min_version: 4134,
        source_file: "Xapi/4134.inl",
        xrefs: XAPI_XSETPROCESSQUANTUMLENGTH_4134_XREFS,
    },
    OovpaPatternMeta {
        name: "GetTypeInformation",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_GETTYPEINFORMATION_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "GetTypeInformation2",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_GETTYPEINFORMATION2_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "MU_Init",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_MU_INIT_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "XFormatUtilityDrive",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_XFORMATUTILITYDRIVE_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "XInputGetState",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_XINPUTGETSTATE_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "XInputOpen",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_XINPUTOPEN_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "XInputSetState",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_XINPUTSETSTATE_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "XMountMUA",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_XMOUNTMUA_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "XMountMURootA",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_XMOUNTMUROOTA_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "XReadMUMetaData",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_XREADMUMETADATA_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "XUnmountMU",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_XUNMOUNTMU_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "XapiInitProcess",
        min_version: 4242,
        source_file: "Xapi/4242.inl",
        xrefs: XAPI_XAPIINITPROCESS_4242_XREFS,
    },
    OovpaPatternMeta {
        name: "CloseHandle",
        min_version: 4361,
        source_file: "Xapi/4361.inl",
        xrefs: XAPI_CLOSEHANDLE_4361_XREFS,
    },
    OovpaPatternMeta {
        name: "CreateThread",
        min_version: 4361,
        source_file: "Xapi/4361.inl",
        xrefs: XAPI_CREATETHREAD_4361_XREFS,
    },
    OovpaPatternMeta {
        name: "XapiSetupPerTitleDriveLetters",
        min_version: 4361,
        source_file: "Xapi/4361.inl",
        xrefs: XAPI_XAPISETUPPERTITLEDRIVELETTERS_4361_XREFS,
    },
    OovpaPatternMeta {
        name: "mainCRTStartup",
        min_version: 4361,
        source_file: "Xapi/4361.inl",
        xrefs: XAPI_MAINCRTSTARTUP_4361_XREFS,
    },
    OovpaPatternMeta {
        name: "XLaunchNewImageA",
        min_version: 4721,
        source_file: "Xapi/4721.inl",
        xrefs: XAPI_XLAUNCHNEWIMAGEA_4721_XREFS,
    },
    OovpaPatternMeta {
        name: "UnhandledExceptionFilter",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_UNHANDLEDEXCEPTIONFILTER_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "XGetDeviceEnumerationStatus",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_XGETDEVICEENUMERATIONSTATUS_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "XID_fCloseDevice",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_XID_FCLOSEDEVICE_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "XInputGetCapabilities",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_XINPUTGETCAPABILITIES_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "XInputGetDeviceDescription",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_XINPUTGETDEVICEDESCRIPTION_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "XInputGetState",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_XINPUTGETSTATE_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "XInputSetLightgunCalibration",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_XINPUTSETLIGHTGUNCALIBRATION_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "XInputSetState",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_XINPUTSETSTATE_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "XapiInitProcess",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_XAPIINITPROCESS_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "mainXapiStartup",
        min_version: 4831,
        source_file: "Xapi/4831.inl",
        xrefs: XAPI_MAINXAPISTARTUP_4831_XREFS,
    },
    OovpaPatternMeta {
        name: "XMountAlternateTitleA",
        min_version: 5028,
        source_file: "Xapi/5028.inl",
        xrefs: XAPI_XMOUNTALTERNATETITLEA_5028_XREFS,
    },
    OovpaPatternMeta {
        name: "XapiInitProcess",
        min_version: 5028,
        source_file: "Xapi/5028.inl",
        xrefs: XAPI_XAPIINITPROCESS_5028_XREFS,
    },
    OovpaPatternMeta {
        name: "MU_Init",
        min_version: 5120,
        source_file: "Xapi/5120.inl",
        xrefs: XAPI_MU_INIT_5120_XREFS,
    },
    OovpaPatternMeta {
        name: "XInitDevices",
        min_version: 5120,
        source_file: "Xapi/5120.inl",
        xrefs: XAPI_XINITDEVICES_5120_XREFS,
    },
    OovpaPatternMeta {
        name: "XLaunchNewImageA",
        min_version: 5344,
        source_file: "Xapi/5344.inl",
        xrefs: XAPI_XLAUNCHNEWIMAGEA_5344_XREFS,
    },
    OovpaPatternMeta {
        name: "GetTypeInformation2",
        min_version: 5455,
        source_file: "Xapi/5455.inl",
        xrefs: XAPI_GETTYPEINFORMATION2_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "XInputGetState",
        min_version: 5455,
        source_file: "Xapi/5455.inl",
        xrefs: XAPI_XINPUTGETSTATE_5455_XREFS,
    },
    OovpaPatternMeta {
        name: "XMountAlternateTitleA",
        min_version: 5455,
        source_file: "Xapi/5455.inl",
        xrefs: XAPI_XMOUNTALTERNATETITLEA_5455_XREFS,
    },
];
